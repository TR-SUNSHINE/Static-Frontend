...
### Branch Rules
A two step review and one step approval is required to merge from the remote branch to the remote repository. <br>
All administrators are allowed to override the two step review and one step approval.
